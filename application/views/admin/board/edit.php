...
<section class="content">
  <?=@$this->session->flashdata('boardEdited')?>
  <div class="row">
    <div class="col-md-12">
      <form role="form"  action="<?php echo base_url('admin/board/edit/'.$member->id) ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-primary"> 
            <div class="box-header">
             <h3 class="box-title">Edit Board Member</h3>
        ...
        <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="logo">Board Member Image</label>
        ...
        <div class="text-center">
          ...
          <a href="<?php echo base_url('admin/board')?>" class="btn btn-info">Back</a> </div>
      </form>
    </div>
  </div>
</section>
