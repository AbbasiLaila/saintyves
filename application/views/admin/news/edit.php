...
<section class="content">
  <?=@$this->session->flashdata('newsEdited')?>
  <div class="row">
    <div class="col-md-12">
      <form role="form"  action="<?php echo base_url('admin/news/edit/'.$post->id) ?>" method="post" enctype="multipart/form-data">
...
<div class="loader"><img src="<?=base_url('assets/adminPanel/images/loader.gif')?>" alt=""></div>        <div class="text-center">
          ...
          <a href="<?php echo base_url('admin/news')?>" class="btn btn-info">Back</a> </div>
      </form>
    </div>
  </div>
</section>
