...
<section class="content">
   <?=@$this->session->flashdata('staffAdded') ?>
   <di class="row">
   <div class="col-md-12">
      <div class="box box-info">
         <div class="box-header">
            ...
            <div class="text-center">
               <a href="<?php echo base_url('admin/staff/add')?>" class="btn btn-primary">Add New Staff Member</a>
            </div>
         </div>
         <!-- /.box-header -->
         <div class="box-body">
            <table id="data-table" class="table table-bordered table-striped">
               ...
               <tbody>
                  ...
                  <tr id="<?php echo $member['id']  ?>">
                     ...
                     <td>
                        <a href="<?php echo base_url('admin/staff/edit/'.$member['id'])?>"><span class="label label-primary">Edit  <i class="fa fa-pencil "></i></span></a>
...
<script>  
   $('.trash').click(function(e){
       ...
       $('#deleteButton').attr({'href':'<?php echo base_url("staff/delete")?>/'+id,'rowid':id});
   });
