            ...
            <table id="data-table" class="table table-bordered table-striped">
               ...
               <tbody>
                  ...
                  <tr id="<?php echo $category['id']  ?>">
                     ...
                     <td>
                        <a href="<?php echo base_url('admin/categories/edit/'.$category['id'])?>"><span class="label label-primary">Edit  <i class="fa fa-pencil "></i></span></a>
...
<script>  
   $('.trash').click(function(e){
       ...
       $('#deleteButton').attr({'href':'<?php echo base_url("categories/delete")?>/'+id,'rowid':id});
   });
