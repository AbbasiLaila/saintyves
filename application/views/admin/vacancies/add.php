...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <form role="form"  action="<?php echo base_url('admin/vacancies/add') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group single col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control datePicker" name="deadline" id="deadline"  value="<?=@$_POST['deadline']?>">
                <!-- /.input group -->
              </div>               
                ...
                <label for="office">Duty station</label>
                 <select class="form-control" name="office">
                  <?php foreach ($offices as $office) {?>
                    <option  <?php  if(@$_POST['office'] == $office['en_name']){ $checked="selected"; }else{$checked="";} ?> <?=$checked;?>  value="<?=$office['en_name']?>" ><?=$office['en_name']?></option>
                  <?php } ?>
                  </select>
              </div>
